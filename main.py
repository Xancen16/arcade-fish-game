...
class Salmon(arcade.Sprite):
    def __init__(self, x, y):
        super().__init__()
        self.textures = []
        self.textures.append(arcade.make_soft_square_texture(50, arcade.color.ORANGE, outer_alpha=255))
        self.textures.append(arcade.make_soft_square_texture(50, arcade.color.DARK_ORANGE, outer_alpha=255))
        self.textures.append(arcade.make_soft_square_texture(50, arcade.color.GOLD, outer_alpha=255))
...
class APP(arcade.Window):
    ...
    def on_update(self, delta_time):
        ...
        if random.randint(1, 100) == 1:
            food = arcade.SpriteSolidColor(20, 20, arcade.color.YELLOW)
